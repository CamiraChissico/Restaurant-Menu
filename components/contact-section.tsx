...
export default function ContactSection() {
  return (
    <div className="px-4 md:px-8 py-8 mt-8 border-t-2 border-[#FF1493]">
      ...
      <h3 className="text-center text-2xl md:text-3xl font-display text-[#FFD700] mb-4">Contact Us</h3>

      <p className="text-center italic mb-8">We'd love to hear from you! ✨</p>
      ...
      <div className="flex flex-col md:flex-row gap-4 max-w-2xl mx-auto">
        ...
        >
          ...
          <div>
            <div className="font-semibold text-[#FFD700]">Call Us</div>
        ...
        >
          ...
          <div>
            <div className="font-semibold text-[#FFD700]">Email Us</div>
